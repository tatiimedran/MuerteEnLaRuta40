...
public class PlayerHealth : MonoBehaviour
{
    ...
    private void HandleDeath()
    {
        ...
        {
            Debug.LogWarning("GameManager.Instance es null. �Est� el GameManager en la escena?");
        }
    }
    ...
    public void SetMaxHealth(int maxHealth)
    {
        ...
        Debug.Log($"Salud restaurada al m�ximo: {currentHealth}");
    }
    public void RestoreFullHealth()
    {
        currentHealth = maxHealth; // Restaura la vida al m�ximo
